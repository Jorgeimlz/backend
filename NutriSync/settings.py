...
DATABASES = {
    'default': {
        ...
        'NAME': 'nutrisyncbdd',  # Nombre de tu base de datos en Render
        'USER': 'nutrisyncbdd_user',  # Usuario proporcionado por Render
        'PASSWORD': 'Mrz4Q6j8jede8gAguJdm8s4jChvhpnV3',  # Contraseña proporcionada por Render
        'HOST': 'dpg-csnu6eggph6c73bkub5g-a.oregon-postgres.render.com',  # Host de la base de datos en Render
